...
#ifndef __UVC_CAMERA2_H_
#define __UVC_CAMERA2_H_
...
public:
	...
	int connect(int vid, int pid, int fd, int busNum, int devAddress, const char *usbFs);
	int release();
